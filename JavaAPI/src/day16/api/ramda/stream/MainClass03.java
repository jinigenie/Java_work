...
public class MainClass03 {
	public static void main(String[] args) {
		...
		for(int i = 0; i < 100; i++) {
			list1.add(ran2.nextInt(100)+ 1);
		}
		System.out.println(list.toString());
		Set<Integer> setto = list1.stream().distinct().filter( b -> b > 50 ).collect(Collectors.toSet());
		System.out.print(setto);
		...
		IntStream.range(1, 10).forEach(a -> System.out.println(a)); //미만까지 정수스트림반환
